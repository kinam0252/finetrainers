...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/disney/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/disney/validation.json"
OUTPUT_DIR="./output/wan-disney"
