...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/NeRF/front-4-noise-none/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/NeRF/front-4-noise-none/validation.json"
OUTPUT_DIR="./output/NeRF-wan-14B-front-4-noise-none"
