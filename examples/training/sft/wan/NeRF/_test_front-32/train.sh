...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/NeRF/_test_front-32/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/NeRF/_test_front-32/validation.json"
OUTPUT_DIR="./output/_test-wan-1.3B-NeRF-front-32"
