...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/NeRF/timeflow-front-none/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/NeRF/timeflow-front-none/validation.json"
OUTPUT_DIR="./output/NeRF-wan-14B-NeRF-timeflow-front-none"
