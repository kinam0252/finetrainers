...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/NeRF/front-none-32/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/NeRF/front-none-32/validation.json"
OUTPUT_DIR="./output/wan-14B-NeRF-front-none-32"
