...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/v2v_animate/front-7-noise-none/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/v2v_animate/front-7-noise-none/validation.json"
OUTPUT_DIR="./output/v2v_animate-wan-14B-NeRF-front-7-noise-none"
...
training_cmd=(
  ...
  --enable_slicing
  --enable_tiling
  --apply_target_noise_only "front-7-noise-none"
)
