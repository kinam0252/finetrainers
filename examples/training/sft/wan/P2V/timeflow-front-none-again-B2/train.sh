...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/P2V/timeflow-front-none-again-B2/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/P2V/timeflow-front-none-again-B2/validation.json"
OUTPUT_DIR="./output/P2V-wan-14B-NeRF-timeflow-front-none-again-B2"
...
training_cmd=(
  ...
  --enable_slicing
  --enable_tiling
  --apply_target_noise_only "front-none"
)
