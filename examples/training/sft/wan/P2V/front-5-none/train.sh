...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/P2V/front-5-none/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/P2V/front-5-none/validation.json"
OUTPUT_DIR="./output/P2V-wan-14B-NeRF-front-5-none"
