...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/P2V/front-5-none-transparent/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/P2V/front-5-none-transparent/validation.json"
OUTPUT_DIR="./output/P2V-wan-14B-NeRF-front-5-none-transparent"
...
training_cmd=(
  ...
  --enable_slicing
  --enable_tiling
  --apply_target_noise_only "front-5-none"
)
