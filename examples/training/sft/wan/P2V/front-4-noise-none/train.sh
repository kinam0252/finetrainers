...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/P2V/front-4-noise-none/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/P2V/front-4-noise-none/validation.json"
OUTPUT_DIR="./output/P2V-wan-14B-NeRF-front-4-noise-none"
...
training_cmd=(
  ...
  --enable_slicing
  --enable_tiling
  --apply_target_noise_only "front-4-noise-none"
)
