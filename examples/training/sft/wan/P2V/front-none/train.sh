...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/P2V/front-none/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/P2V/front-none/validation.json"
OUTPUT_DIR="./output/P2V-wan-14B-NeRF-front-none"
