...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/_test/front-none/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/_test/front-none/validation.json"
OUTPUT_DIR="./output/_test-wan-1.3B-NeRF-front-none"
