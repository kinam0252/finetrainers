...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/VITON/front-2-none-R128/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/VITON/front-2-none-R128/validation.json"
OUTPUT_DIR="./output/_test_VITON-wan-14B-NeRF-front-2-none-R128"
...
training_cmd=(
  ...
  --enable_slicing
  --enable_tiling
  --apply_target_noise_only "front-2-none"
)
