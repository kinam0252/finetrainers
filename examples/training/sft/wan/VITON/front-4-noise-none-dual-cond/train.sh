...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/VITON/front-4-noise-none-dual-cond/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/VITON/front-4-noise-none-dual-cond/validation.json"
OUTPUT_DIR="./output/VITON-wan-14B-NeRF-front-4-noise-none-dual-cond"
...
training_cmd=(
  ...
  --enable_slicing
  --enable_tiling
  --apply_target_noise_only "front-4-noise-none-dual-cond"
)
