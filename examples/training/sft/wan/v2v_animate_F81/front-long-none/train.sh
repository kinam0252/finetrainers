...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/v2v_animate_F81/front-long-none/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/v2v_animate_F81/front-long-none/validation.json"
OUTPUT_DIR="./output/wan-v2v_animate-front-long-none-F81"
...
training_cmd=(
  ...
  # --enable_slicing
  --enable_tiling
  --apply_target_noise_only "front-long-none-F81"
)
